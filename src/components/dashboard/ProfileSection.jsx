        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="text-base font-medium text-base-content dark:text-white truncate underline">
                <a href="https://wa.link/k0g8tt" target="_blank" rel="noopener noreferrer">06 88 78 46 09</a>
              </div>
            </div>
          </div>
