					...
					<div className="max-w-7xl mx-auto px-4 sm:px-6 w-full">
						<div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[calc(100vh-8rem)] lg:min-h-0">
							...
							<div className="text-left order-2 lg:order-1">
								{/* Title */}
								<h1 className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-4 lg:mb-6 transition-all duration-1000 ${
								...
								{/* Description */}
								<div className={`text-lg sm:text-xl lg:text-2xl text-base-content/90 mb-6 lg:mb-10 leading-relaxed transition-all duration-1000 delay-300 ${
									showText ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
								}`}>
									<TextType 
								...
								{/* CTA Buttons */}
								<div className={`flex flex-col sm:flex-row items-center sm:items-start gap-3 sm:gap-4 transition-all duration-1000 delay-600 ${
									showText ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
								}`}>
							...
							{/* Right Column - Image */}
							<div className={`relative transition-all duration-1000 delay-900 order-1 lg:order-2 ${
