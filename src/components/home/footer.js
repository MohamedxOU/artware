...
export default function Footer() {
  ...
  return (
    <footer 
      id="footer-section" 
      className="relative w-full bg-base-200 text-neutral-content overflow-hidden border-t border-base-content/20"
      style={{
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 bg-primary rounded-xl flex items-center justify-center">
                <span className="text-primary-content font-bold text-xl">AW</span>
              </div>
              <div>
                <h3 className="text-2xl font-bold text-white">ArtWare</h3>
                <p className="text-sm text-neutral-content/60">Innovation Club</p>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              <a 
                ...
                aria-label="Facebook"
              >
                <svg className="w-5 h-5 fill-current text-white group-hover:text-primary-content" viewBox="0 0 24 24">
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="#hero" className="text-neutral-content/80 hover:text-primary transition-colors duration-300 text-sm">
                  Accueil
                </Link>
              </li>
              <li>
                <Link href="#about" className="text-neutral-content/80 hover:text-primary transition-colors duration-300 text-sm">
                  À Propos
                </Link>
              </li>
              <li>
                <Link href="#activities" className="text-neutral-content/80 hover:text-primary transition-colors duration-300 text-sm">
                  Activités
                </Link>
              </li>
              <li>
                <Link href="#bureau" className="text-neutral-content/80 hover:text-primary transition-colors duration-300 text-sm">
                  Notre Bureau
                </Link>
              </li>
              <li>
                <Link href="#contact" className="text-neutral-content/80 hover:text-primary transition-colors duration-300 text-sm">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <ul className="space-y-3">
              <li>
                <span className="text-neutral-content/80 text-sm">Formation Technique</span>
              </li>
              <li>
                <span className="text-neutral-content/80 text-sm">Workshops & Hackathons</span>
              </li>
              <li>
                <span className="text-neutral-content/80 text-sm">Projets Collaboratifs</span>
              </li>
              <li>
                <span className="text-neutral-content/80 text-sm">Mentorat Professionnel</span>
              </li>
              <li>
                <span className="text-neutral-content/80 text-sm">Événements Tech</span>
              </li>
            </ul>
          </div>
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-neutral-content/80 text-sm">ENSA Khouribga</p>
                  <p className="text-neutral-content/60 text-xs">Khouribga, Maroc</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <p className="text-neutral-content/80 text-sm">contact@artware.ma</p>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <p className="text-neutral-content/80 text-sm">+212 655-0108</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={`border-t border-white/10 pt-8 transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6">
              <Link href="#" className="text-neutral-content/60 hover:text-primary text-sm transition-colors duration-300">
