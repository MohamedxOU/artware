...
const LetterGlitch = ({
  ...
  // Always use dark theme colors (grays and purples)
  const defaultGlitchColors = ['#4a5568', '#9333ea', '#a855f7', '#c084fc'];
  const activeGlitchColors = glitchColors || defaultGlitchColors;
