...
export default function ResetPasswordPreviewPage() {
  ...
  return (
    <div className={`relative min-h-screen bg-base-300 overflow-hidden ${isDarkMode ? 'opacity-80' : 'opacity-100'}`}>
      ...
      {/* Preview Banner */}
      <div className="fixed top-0 left-0 right-0 bg-warning/90 text-warning-content px-4 py-2 text-center text-sm font-medium z-50">
          ...
          {!isSuccess ? (
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="text-center mt-6">
                  <Link href="/login" className="cursor-target text-base-content/60 hover:text-primary text-sm font-medium">
                    ← Back to Login
                  </Link>
                </div>
              </form>
            ...
            <div className="text-center">
              ...
              <p className="text-base-content/70 text-sm mb-6 leading-relaxed">
                ...
                <br />
                <span className="text-base-content/50">(Preview mode - no redirect)</span>
              </p>
